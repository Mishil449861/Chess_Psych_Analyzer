...
from chess_psych.config import setup_logging  # noqa: E402
setup_logging()

from chess_psych.blunders import detect_blunders  # noqa: E402
from chess_psych.db import get_conn, get_or_create_user, init_db  # noqa: E402
from chess_psych.features import extract_move_features  # noqa: E402
from chess_psych.ingest import ingest_pgn  # noqa: E402
from chess_psych.llm_summary import generate_user_summary  # noqa: E402
from chess_psych.patterns import cluster_blunders  # noqa: E402
...
1. e4 e5 2. Nf3 Nc6 3. Bc4 Nf6 4. d3 Bc5 5. O-O O-O 6. Bg5 h6 7. Bh4 d6 8. Nbd2 Bg4 9. h3 Bxf3 10. Nxf3 Nh5 11. Bxd8 Rfxd8 0-1
""",
]
